...
export function Slider({ className, ...props }: ComponentProps<typeof SliderPrimitive.Root>) {
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block size-4 rounded-full border border-border bg-primary shadow-none outline-none focus-visible:ring-2 focus-visible:ring-ring/50" />
    </SliderPrimitive.Root>
  );
}
