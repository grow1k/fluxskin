...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CwZUmE_z.mjs");
...
var manifest = {
	"095003ca09fb815b1d802b01b837175e6a4d61c4d331419e620b469cc3517d16": {
		functionName: "equipItem_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"28f9e69d6df652207e0b9693e26b9b5934eadc8956ac948bd53f7aebabcd49a8": {
		functionName: "rotateAccessKey_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"47511a1cdb3d3f744e548d409358fb0e03c669210ef3c3e157c23d2b3456ecc7": {
		functionName: "buyStars_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"484fa47641b9b3c5a142a687f939b848ddb86536ca64058fe533ecfa8b296bf9": {
		functionName: "buyPlan_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"68903cab4bd33a63ef5ffabb0e0bdb809ada27c5af31623a22aae43f5b28bdee": {
		functionName: "openCase_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"7cb8f5edf66f9decd283c106ee6a337086f2c325409476b5cd7530c8fa6921c0": {
		functionName: "updateItem_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"a3e74e6e1e6c649f179264fb01c25e254b09d47c0ab7b357a311b2187e735ddb": {
		functionName: "buyKey_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"a7343109f52ea1f9c4130b5f17fa6197f52120ffb227a40470f1f6d82dd399e3": {
		functionName: "getDashboard_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"a88ab65316a4250d9611fa97830d2d420c41075e8d99d9d3ae1e27a4c5261b0b": {
		functionName: "addItem_createServerFn_handler",
		importer: () => import("./flux-BAXpCYQb.mjs")
	},
	"ea1a754f93e43de18a10fa3e4d1d2cc3b435126839c4883a027ccb4c5e15f3c1": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Df5wO025.mjs").then((n) => n.t),
